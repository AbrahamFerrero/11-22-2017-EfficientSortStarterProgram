...
public class QuakeEntry implements Comparable<QuakeEntry>{
    ...
    //Modified by Abraham Ferrero for Assignment 1:
    @Override
    public int compareTo(QuakeEntry loc) {
       /*As I modified it, now it sorts by magnitude but when the magnitude is the same (the else statement)
        * it returns another comparable, sorting by depth(with the double.compare method). 
        */
